        ...
        const ChartjsNode = require('chartjs-node');
                var chartJsOptions = {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: "Data",
                            borderColor: "rgba(72, 178, 110, 1)",
                            pointBorderColor:"rgba(72, 178, 110, 1)",
                            pointBackgroundColor:"rgba(72, 178, 110, 1)",
                            pointHoverBackgroundColor:"rgba(72, 178, 110, 1)",
                            pointHoverBorderColor:"rgba(72, 178, 110, 1)",
                            pointBorderWidth: 1,
                            pointHoverRadius: 1,
